...
// ส่วนสร้าง Node
    ...
    public static void main(String[] args) {
        ...
        // สร้าง Node
        Node1<String> p = new Node1<String>("black");
        Node1<String> q = new Node1<String>("pink");
        Node1<String> m = new Node1<String>("orange");
        Node1<String> n = new Node1<String>("blue");
        ...
        while (curr != null) {
            ...
            if (curr.value.equals("blue")) {
                ...
                System.out.println("ค่าที่ค้นพบ = " + curr.value);
                break;
            }
